...
namespace UseCases.Test.Expenses.GetById
{
    public class GetExpenseByIdUseCaseTest
    {
        ...
        public async Task Success()
        {
            ...
            result.PaymentType.Should().Be((PaymentTypeEnum)expense.PaymentType);
        }
        ...
        private static GetExpenseByIdUseCase CreateUseCase(UserEntity user, ExpenseEntity? expense = null)
        {
